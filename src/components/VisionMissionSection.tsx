    ...
    <section id="vision-mission" className="section-spacing bg-empowerher-pink-light dark:bg-black transition-colors">
      <div className="container mx-auto">
        <div className="grid lg:grid-cols-2 gap-12">
          {/* Our Vision */}
          <div className="bg-white dark:bg-gray-900 p-8 rounded-2xl shadow-sm transition-colors">
            <div className="flex items-center space-x-3 mb-6">
              <div className="bg-empowerher-pink-medium p-3 rounded-full">
                <Eye className="h-6 w-6 text-empowerher-pink-dark" />
              </div>
              <h3 className="text-2xl font-bold text-gray-800 dark:text-white transition-colors">Our Vision</h3>
            </div>
            <p className="text-gray-600 dark:text-white leading-relaxed mb-6 transition-colors">
          ...
          <div className="bg-white dark:bg-gray-900 p-8 rounded-2xl shadow-sm transition-colors">
            <div className="flex items-center space-x-3 mb-6">
              ...
              <h3 className="text-2xl font-bold text-gray-800 dark:text-white transition-colors">Our Mission</h3>
            </div>
            <p className="text-gray-600 dark:text-white leading-relaxed mb-6 transition-colors">
