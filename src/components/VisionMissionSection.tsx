...
const VisionMissionSection = () => {
  return (
    <section id="vision-mission" className="section-spacing bg-pastel-pearl">
      <div className="container mx-auto">
        <div className="grid lg:grid-cols-2 gap-12">
          {/* Our Vision */}
          <div className="bg-white p-8 rounded-2xl shadow-sm">
            <div className="flex items-center space-x-3 mb-6">
              <div className="bg-pastel-flesh p-3 rounded-full">
                <Eye className="h-6 w-6 text-pastel-khaki" />
              </div>
          ...
          <div className="bg-white p-8 rounded-2xl shadow-sm">
            <div className="flex items-center space-x-3 mb-6">
              <div className="bg-pastel-flesh p-3 rounded-full">
                <Target className="h-6 w-6 text-pastel-khaki" />
              </div>
            ...
            <div className="bg-pastel-flesh p-6 rounded-lg text-center">
              <Target className="h-16 w-16 text-pastel-khaki mx-auto mb-4" />
